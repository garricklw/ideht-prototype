...
var IDEHTViz = function () {
    ...
    this.setupVisualization = function (canvasElementName, data) {
        ...
        var networkData = {
            "nodes": [{"id": "Person 1", "metaData1": 0.5}, {
                "id": "Person 2",
                "metaData1": 1.0
            }, {"id": "Person 3", "metaData1": 0.2}],
            "links": [{
                ...
                "metaData1": 0.25,
                "metaData2": 0.1
            }, {"sourceNodeId": "Person 2", "targetNodeId": "Person 3", "metaData1": 0.3, "metaData2": 0.25}]
        };
    ...
    this.updateLayout = function (layout) {
        ...
        if (layout.type != "FORCE_DIRECTED") {
            for (var nodeId in layout.xPositions) {
                that.vs.overrideNodePosition("Dataset0", nodeId, {
                    x: layout.xPositions[nodeId],
                    y: layout.yPositions[nodeId],
                    z: layout.zPositions[nodeId]
                });
            }
    ...
    this.makeNetwork = function (net) {
        ...
        var simpleVisualizationStyle = new VisualizationStyle("Simple", {
            "Force-Directed": new ForceDirectedLayout(100.0, that.vs.getLayoutManager(), that.perspective)
        });
