...
var ModelRepository = function (vs) {
    ...
    that.getDisk = function (datasetId, visId, visName, lookAndFeel, castShadow, receiveShadow, callback, connectionObj) {
    ...
    that.makeLabelSprite = function (labelText, borderColor, backgroundColor, layoutScale, objectScale) {
        ...
        return that.makeTextSprite(labelText, layoutScale, objectScale, {
            ...
            fontColor: {r: contrastColor[0], g: contrastColor[1], b: contrastColor[2], a: 1.0}
        });
